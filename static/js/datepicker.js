		...
		var	ids = {},
			...
			tpl = {
				...
				head: [
					...
					'<table cellpadding="0">',
						'<thead>',
							'<tr class="month-select">',
								'<th class="datepickerGoPrev"><a href="#"><span><%=prev%></span></a></th>',
								'<th colspan="5" class="datepickerMonth" onclick="return false;"><a href="#" onclick="return false"><span></span></a></th>',
			...
			click = function(ev) {
				...
				if (el.is('a')) {
					...
					if (parentEl.is('th')) {
						...
						} else if (parentEl.hasClass('adatepickerMonth')) {
							tmp.addMonths(tblIndex - Math.floor(options.calendars/2));
